                            ...
                            <div className="registration-card-3d-wrap mx-auto">
                                <div className="registration-card-3d-wrapper">
                                    ...
                                    <div className="registration-card-back">
                                        <div className="registration-center-wrap">
                                                <div  className='blackbox'><h4 className="mb-4 pb-3">Sign Up</h4></div>
                                                <input type="submit" className="registration-btn mt-4 btn" value="Signup as Patient"/>
                                                <input type="submit" className="registration-btn mt-4 btn" value="Signup as Hospital"/>
                                                <input type="submit" className="registration-btn mt-4 btn" value="Signup as Doctor"/>
                                          </div>
                                      </div>
                                  </div>
                              </div>
