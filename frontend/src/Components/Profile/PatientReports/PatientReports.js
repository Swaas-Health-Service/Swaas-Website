    ...
    <div className="patient-detail">
      ...
      <div className="patient-information">
        <div className="pa-info-btns">
          <button className="print-btn pa-btns">
            Print Patient Report & Prescription
          </button>
        ...
        <div className="pa-info-rate">
          <div className="dis-rate ">
            <div className="vitalsign-image">
              <img src={Heart} alt="" className="vitalsign-icons" />
            </div>
            <div className="heart-rate-info">Heart Rate</div>
          </div>
          <div className="dis-rate">
            <div className="vitalsign-image">
              <img src={Lungs} alt="" className="vitalsign-icons" />
            </div>
            <div className="heart-rate-info">Oxygen Saturation</div>
          </div>
          <div className="dis-rate">
            <div className="vitalsign-image">
              <img src={Temp} alt="" className="vitalsign-icons" />
            </div>
            <div className="heart-rate-info">Body Temperature</div>
          </div>
          <div className="dis-rate">
            <div className="vitalsign-image">
              <img src={Glucose} alt="" className="vitalsign-icons" />
            </div>
        ...
        <div className="pa-info-test">
          ...
          <div className="scan-test">
            <div className="scan-test-info">
              <img
                src={PatientReport}
                alt=""
                className="Patient-Report-Image"
              />
              CT Scan Test
            </div>
            <div className="scan-test-info">
